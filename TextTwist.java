...
public class TextTwist extends JPanel implements MouseListener, ActionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        case MAIN_MENU:
            ...
            buttonBoard2.setBounds(100, 200, 300, 100);
            ...
            buttonBoard3.setBounds(100, 300, 300, 100);
            ...
            buttonBoard4.setBounds(100, 350, 300, 100);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            } else if (buttonBoard3.getModel().isPressed()) {
